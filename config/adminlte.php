...
return [
    ...
    */
    ...
    'logo' => '<b>Plica</b>Ritmica',
    'logo_img' => 'vendor/adminlte/dist/img/logoplica.png',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'    => 'Facturas',
            'icon'    => 'fas fa-receipt',
            'can'=>   ['facturas.create','facturas.show','facturas.edit','facturas.destroy'],     
            'submenu' => [
                [
        ...
        [
            ...
            'can'=>   ['pagos.create','pagos.show','pagos.edit','pagos.destroy'],     
            'submenu' => [
                [
                    'text' => 'Lista de Pagos',
                    'icon' => 'fas fa-list-ul',
        ...
        'Tempus Dominus' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.0/moment.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
