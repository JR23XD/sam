  ...
  <div class="modal-dialog modal-sm"
    ...
    <div class="modal-content">
      <div class="modal-header p-1 bg-dark">
        ...
        <button type="button"
                class="close p-0 m-0 text-light"
                data-dismiss="modal"
                aria-label="Close">
        ...
        <form action=""
              ...
              <div class="input-group">
                <div class="input-group-prepend">
                  <button class="btn border"
                          id="btn-menos-uno"><i class="fas fa-minus"></i></button>
                </div>
                <input type="number"
                       id="numero-caracteres"
                       class="form-control btn-sm"
                       readonly
                       value="{{ config('app.longitud_del_password') }}">
                <div class="input-group-prepend">
                  <button class="btn border"
                          id="btn-mas-uno"><i class="fas fa-plus"></i></button>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="form-group col-sm btn-sm">
              ...
              <div class="input-group">
                <button class="btn border"
                        id="btn-simbolos"><i class="fas fa-check"></i></button>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="form-group col-sm btn-sm">
              ...
              <div class="input-group">
                <button class="btn border"
                        id="btn-numeros"><i class="fas fa-check"></i></button>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="form-group col-sm btn-sm">
              ...
              <div class="input-group">
                <button class="btn border"
                        id="btn-mayusculas"><i class="fas fa-check"></i></button>
              </div>
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="form-group col-sm btn-sm">
              <center><button class="btn btn-info w-100 p-2"
                        id="btn-generar"><i class="fas fa-check-circle text-dark"></i> {{ __('Generar') }}</button>
              </center>
            </div>
          </div>
          <div class="row">
            <div class="form-group col-sm btn-sm">
              <div class="input-group">
                <input type="text"
                       class="input-password form-control btn-sm"
                       id="input-password"
                       readonly
                       value="3f/PgF=d$0"
