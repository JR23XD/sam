<nav class="navbar navbar-expand-lg pt-1">
  <button class="navbar-toggler border rounded"
          type="button"
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item">
        <div class="input-group input-group-sm"
             style="width: 13em;">
          {{ __('Mostrar') }}
          &nbsp{!! Form::select('paginador', ['15' => '15', '30' => '30', '50' => '50', '100'=>'100'], null, ['class' => 'form-control btn-sm w-25', 'onchange' => 'this.form.submit()']) !!}&nbsp
          {{ __('registros') }}.
      ...
      <div class="input-group input-group-sm">
        ...
        <div class="input-group-append">
          <a href="{{ $ruta_recarga }}"
             ...
             title="{{ __('Mostrar todos los registros') }}"><i class="fas fa-spinner"></i></a>
        </div>
      </div>
      <span class="pantallaMax985px">
        <button type="submit"
                class="btn btn-outline-success btn-sm my-2 my-sm-0 ml-3"><i class="fas fa-search"></i>
          {{ __('Buscar') }}</button>
      </span>
    </div>
  </div>
